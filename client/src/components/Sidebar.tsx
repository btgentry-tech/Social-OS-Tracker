    ...
    <div className="w-64 border-r border-border/50 bg-card/30 backdrop-blur-xl flex flex-col h-full z-10 relative">
      <div className="p-6 flex items-center gap-3 border-b border-border/50">
        ...
        <div className="flex flex-col">
          <span className="font-semibold tracking-tight text-lg leading-tight" data-testid="text-app-name">Creator OS</span>
          <span className="text-[10px] text-muted-foreground font-mono">v2 — Intelligence Mode</span>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-border/50">
        <div className="flex items-center gap-3 px-3 py-2">
          <div className="w-8 h-8 rounded-full bg-secondary border border-border flex items-center justify-center overflow-hidden">
            <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=CreatorOS&backgroundColor=transparent" alt="User" className="w-full h-full opacity-80 mix-blend-screen" />
          </div>
          <div className="flex flex-col">
